...
//import com.tocersoft.base.util.LogUtil;
...
public class AlipayNotify {
    ...
    public static boolean verify(Map<String, String> params) {
		...
		if(StringUtils.isNotBlank(params.get("notify_id"))) {
			responseTxt = verifyResponse(params.get("notify_id"));
//            LogUtil.log("verifyResponse: "+responseTxt);
		}
	    String sign = "";
...
//        LogUtil.log("isSign: "+String.valueOf(isSign));
...
//        LogUtil.log("preSignStr: "+preSignStr);
        //获得签名验证结果
